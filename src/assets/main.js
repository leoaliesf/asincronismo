const API = 'https://youtube-v31.p.rapidapi.com/search?channelId=%40gndx&part=snippet%2Cid&order=date&maxResults=10';
const options = {
	method: 'GET',
	headers: {
...
(async()=>{
    try {
        ...
        let view = `
        ${videos.items.map(videos=>` <div class="bg-gray-50">
